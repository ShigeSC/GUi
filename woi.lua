...
do
    ...
    function C.ReadSharedBatch()
        ...
        for _, server in ipairs(data.servers) do
            ...
            if jobId ~= "" and not consumed[jobId] then
    ...
    C.WriteOwn()
    C.DebugLines = {}
    C.Debug(string.format("V11 shared persistent 100-batch failover start user=%s userId=%s placeId=%s jobId=%s sharedClaims=%s",
...
-- =========================================================
-- PET PROTECT LOGIC + CENTRALIZED AUTO SERVER HOP V11
-- =========================================================
